  ...
  async update(principal: AuthenticatedPrincipal, id: string, dto: UpdateDeviceDto) {
    ...
    const device = await this.prisma.broadcastDevice.update({
      ...
      data: {
        ...
        ...(dto.supportsCellular !== undefined ? { supportsCellular: dto.supportsCellular } : {}),
        ...(dto.supportsEthernet !== undefined ? { supportsEthernet: dto.supportsEthernet } : {}),
        ...(dto.supportsWifi !== undefined ? { supportsWifi: dto.supportsWifi } : {}),
